# Service Notification Router (`service-notification-router`) — factory product contract

This repository is one product built by the Param Factory. It ships at
`https://service-notification-router.sociobot.in`. Artifact class: `web-with-backend`.
